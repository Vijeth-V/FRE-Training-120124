...
@Component({
  selector: 'app-change-list-elements',
  standalone: false,
  
  templateUrl: './change-list-elements.component.html',
  styleUrl: './change-list-elements.component.css'
})
export class ChangeListElementsComponent {
  ...
  selectedElement = this.lists[0];

  handleClick(list: any) {
